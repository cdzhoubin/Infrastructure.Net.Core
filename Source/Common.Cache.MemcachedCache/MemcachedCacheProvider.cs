...
namespace Zhoubin.Infrastructure.Common.Cache.MemcachedCache
{
    ...
    public class MemcachedCacheProvider : CacheProvider
    {
        ...
        public override bool Add(string strKey, object objValue)
        {
            ...
            {
                return bucket.Replace(KeySuffix + strKey, objValue).Success;
            }
        ...
        public override bool Add(string strKey, object objValue, TimeSpan timeSpan)
        {
            ...
            using (var bucket = _cluster.OpenBucket())
            {
                return bucket.Replace(KeySuffix + strKey, objValue, timeSpan).Success;
            }
        }
        ...
        public override object Get(string strKey)
        {
            ...
            using (var bucket = _cluster.OpenBucket())
            {
                return bucket.Get<object>(KeySuffix + strKey);
            }
        }
        ...
        public override ulong Increment(string key, ulong amount)
        {
            ...
            using (var bucket = _cluster.OpenBucket())
            {
                return bucket.Increment(KeySuffix + key, DefaultExpireTime, amount).Value;
            }
        }
        ...
        public override ulong Decrement(string key, ulong amount)
        {
            ...
            using (var bucket = _cluster.OpenBucket())
            {
                return bucket.Decrement(KeySuffix + key, DefaultExpireTime, amount).Value;
            }
        }
