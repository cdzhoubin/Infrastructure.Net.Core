...
namespace Zhoubin.Infrastructure.Net.Core.Common.Cryptography
{
    /// <summary>
    /// 加密配置帮助类
    /// </summary>
    ...
    public sealed class EncryptionConfigEntity : ConfigEntityBase<EncryptionConfigEntity>
    {
        ...
        public static EncryptionConfigEntity CreateEncryptionConfigEntity(string algorithmProvider,
            bool symmetricAlgorithm, Dictionary<string, string> extentProperty)
        {
        ...
        protected override void SetProperty(EncryptionConfigEntity entity, IConfigurationSection provider)
        {
            entity.AlgorithmProvider = GetKeyValue(provider, "AlgorithmProvider");
            entity.SymmetricAlgorithm = GetKeyValue(provider, "SymmetricAlgorithm").ToLower() == "true";
        }
